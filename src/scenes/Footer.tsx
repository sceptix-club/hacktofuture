    ...
    return (
      <div
        ...
        style={{
          ...
          overflow: "hidden",
          contain: "strict", // upgraded: removes from compositor when off-screen
        }}
      >
        {/* Only render the animated grid bg when footer is actually visible */}
        {isActive && (
            ...
            <div>
              <div className="px-6 md:px-12 lg:px-20 pt-6">
                <div className="w-full rounded-xl overflow-hidden border border-white/10">
                  {/* Lazy-load iframe — only insert into DOM when footer is active */}
                  {isActive && (
                    <iframe
                  ...
                  {!isActive && (
                    <div style={{ height: 300, background: "#111" }} />
                  )}
                </div>
              </div>

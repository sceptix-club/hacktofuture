...
const cards = [
  [
    { time: "3:00PM", event: "Registrations" },
    { time: "6:00PM", event: "Inauguration" },
    { time: "7:00PM", event: "Hackathon Begins" },
    { time: "7:00PM", event: "Mentor Visit" },
    { time: "8:00PM", event: "Dinner" },
  ],
  [
    { time: "8:00AM", event: "Breakfast" },
    { time: "9:00AM", event: "Mentoring Session" },
    { time: "12:30PM", event: "Lunch" },
    { time: "3:00PM", event: "Mentoring Session" },
    { time: "6:00PM", event: "Snacks" },
    { time: "7:00PM", event: "Cultural Program" },
    { time: "8:30PM", event: "Dinner" },
  ],
  [
    { time: "7:00AM", event: "Hackathon Ends" },
    { time: "7:15AM", event: "Breakfast" },
    { time: "8:00AM", event: "Judgement Round" },

...
export default function PSPageClient({ data, loaderDone }: Props) {
  ...
  const isOpenInnovation = data.slug === "open-innovation";
          ...
          <main className="relative min-h-screen text-white">
            <div className="relative" style={{ zIndex: 2 }}>
              <div className="max-w-5xl mx-auto px-6 md:px-12 pt-28 pb-24 -mt-12">
                ...
                {/* ── PS Navigation (hide for open innovation since there's only one) ── */}
                {!isOpenInnovation && (
                ...
                <section ref={contentRef}>
                  {/* PS Title (hide for open innovation since it's redundant) */}
                  {!isOpenInnovation && (
                    <h2

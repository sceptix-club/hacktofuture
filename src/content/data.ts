    ...
    problemStatements: [
      {
        ...
        prerequisites: [
          "Knowledge of agentic AI and multi-agent systems, understanding how autonomous agents coordinate tasks and workflows using frameworks such as LangGraph, CrewAI, or AutoGen.",
          "Familiarity with CI/CD pipelines and tools like GitHub Actions, Jenkins, or GitLab CI.",
          "Ability to analyze logs and test reports using LLM-based reasoning.",
          "Solid understanding of security principles such as least-privilege access and audit trails for autonomous systems.",
          "Experience with backend development and integration with version control and deployment APIs.",
        ],
      },
      {
        id: "T1PS2",
        ...
        prerequisites: [
          "Understanding of agentic AI and multi-agent architectures, including how autonomous agents coordinate tasks across distributed systems.",
          "Experience integrating developer tools such as GitHub, Jira, Slack, Confluence, and monitoring systems.",
          "Familiarity with vector databases or knowledge graphs for organizing and querying unstructured data.",
          "Understanding of internal developer platforms, self-service infrastructure concepts, and developer experience engineering.",
          "Ability to design human-in-the-loop workflows where autonomous actions are auditable and controlled.",
        ],
      },
    ],
  },
    ...
    problemStatements: [
      {
        ...
        prerequisites: [
          "Understanding of Zero Trust architecture concepts including continuous authentication and identity-centric security.",
          "Knowledge of behavioral biometrics such as keystroke dynamics and user interaction patterns.",
          "Familiarity with authentication protocols including OAuth 2.0, OpenID Connect, and identity federation.",
          "Experience applying machine learning or anomaly detection techniques for security monitoring.",
          "Familiarity with enterprise monitoring systems such as SIEM platforms and real-time event processing pipelines.",
        ],
      },
      {
        id: "T2PS2",
        ...
        prerequisites: [
          "Knowledge of agentic AI and multi-agent systems where autonomous agents collaborate and simulate adversarial scenarios.",
          "Understanding of cybersecurity concepts such as threat modeling, vulnerability scanning, penetration testing, and defensive monitoring systems.",
          "Experience building AI systems for analyzing security logs and detecting anomalies.",
          "Familiarity with distributed systems, enterprise infrastructure environments, and secure sandbox or digital twin simulations.",
        ],
      },
    ],
  },
    ...
    problemStatements: [
      {
        ...
        prerequisites: [
          "Solid understanding of Linux process lifecycle concepts including signals, process states, and graceful shutdown behavior.",
          "Knowledge of containerization and resource isolation mechanisms.",
          "Familiarity with Kubernetes fundamentals such as pods, nodes, scheduling policies, and resource limits.",
          "Experience with cluster monitoring tools and performance observability systems such as Prometheus.",
        ],
      },
      {
        id: "T3PS2",
        ...
        prerequisites: [
          "Understanding of agentic AI and multi-agent architectures capable of reasoning about system state and coordinating remediation actions.",
          "Familiarity with cloud-native infrastructure concepts including Kubernetes, container orchestration, and microservices.",
          "Experience with observability tools such as Prometheus, Grafana, and OpenTelemetry.",
          "Comfort interacting with Kubernetes APIs and automating infrastructure operations using cloud-agnostic tooling.",
        ],
      },
    ],
  },
    ...
    problemStatements: [
      {
        ...
        prerequisites: [
          "There are no strict prerequisites for this track.",
          "Bring curiosity, creativity, and the willingness to experiment.",
          "Strong ideas, thoughtful design, and effective execution matter more than following predefined rules.",
          "Focus on identifying a meaningful problem, designing a practical solution, and building a working prototype that clearly demonstrates impact and feasibility.",
        ],
      },
    ],
  },
